...
> **Tidak punya Git?** Klik tombol hijau **Code** di halaman ini → **Download ZIP** → unzip → pindahkan folder ke `~/Documents/Diagnostic-Tool/` → jalankan dua perintah terakhir di atas.
...
Simpan report lama untuk mmemantau tren seiring waktu.
...
```
1. Buka Terminal
2. Jalankan: bash ~/Documents/Diagnostic-Tool/run_diagnostic.sh
